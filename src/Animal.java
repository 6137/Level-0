	...
	public class Animal {
		...
		Animal() {
			...
			for (int i = 0; i < 100; i++) {
				...
				name = JOptionPane.showInputDialog("What animal do you want?");
			...
			else if(name.equalsIgnoreCase("Llama")){
			...
			else
			{
				...
				JOptionPane.showMessageDialog(null, "You have entered something that is not a good animal. Try again!");
